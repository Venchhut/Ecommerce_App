...
const ProductScreen = ({ route, navigation }) => {
  ...
  return (
    <SafeAreaView
      style={{ marginTop: 15, flex: 1, backgroundColor: Colors.background }}
    >
      {/* A modal */}
      <Modal
        animationType={"fade"}
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ color: Colors.titleColor, fontWeight: "bold" }}>
              Product Details
            </Text>
          </View>
        ...
        <View style={{ marginTop: 30 }}>
          <Text style={{ fontSize: 15.5, color: Colors.textPrimary }}>
            Men's Shoe
          </Text>
          <Text
            style={{
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <View style={{ flexDirection: "row", alignSelf: "flex-end" }}>
                ...
                <Text
                  style={{ marginHorizontal: 6, fontSize: 18, color: "black" }}
                >
                  EU
                </Text>
              </View>
      ...
      <View style={{ justifyContent: "flex-end", backgroundColor: "#fff" }}>
        <TouchableOpacity
          ...
          onPress={() => {
            cartItems.push(product_item), changeModalVisibility(true);
          }}
        >
...
const ProductShots = ({ shots, selectedShot, selectShot, navigation }) => (
  <View style={{ flexDirection: "row" }}>
    ...
    <View style={{ justifyContent: "flex-end" }}>
      ...
      {shots.map((shot, index) => {
        return (
          <TouchableOpacity
            style={[
              styles.product_shots,
              selectedShot == index && styles.selected_shot,
            ]}
            key={index}
